...
const L: Record<string, LinkItem> = {
  ...
  resume:   { index: '06', label: 'RESUME',         sublabel: 'CV & EXPERIENCE',         url: 'https://drive.google.com/file/d/1TodzckBqTjTNPIOfR4ZA-ATBytBp7DsF/view?usp=sharing', color: P.pink,   icon: 'document-text-outline'}, 
